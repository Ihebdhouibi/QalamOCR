...
arabic_docs_root = (
    ...
    "arabic-documents-ocr-dataset/Documents/Documents"
)
    ...
    if root.endswith("/img"):
        for img in files:
            if img.lower().endswith((".jpg", ".jpeg", ".png")):
                ...
                ann_path = os.path.join(ann_root, os.path.splitext(img)[0] + ".json")
...
yarmouk_pdf_root = (
    "/kaggle/input/datasets/eyadwin/"
    "yarmouk-ocr-dataset/Training/Training/"
    "Scanned/training/training"
)

yarmouk_text_root = (
    "/kaggle/input/datasets/eyadwin/yarmouk-ocr-dataset/Training/Training/OCR/text/text"
)
...
with open("unified_metadata.json", "w", encoding="utf-8") as f:
    json.dump(unified_samples, f, ensure_ascii=False, indent=4)
